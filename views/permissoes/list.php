			...
			<tbody>
				<?php foreach ($list as $item): ?>
					<tr id="row-<?php echo $item->id ?>">
						...
						<td>
							<a href="<?php echo UrlHelper::getRoot() ?>permissoes/<?php echo $item->id ?>"><?php echo $item->nome ?></a>
						</td>
						<td>
							<div class="btn-group pull-right">
								<a href="<?php echo UrlHelper::getRoot() ?>permissoes/edit/<?php echo $item->id ?>" class="btn btn-mini">Editar</a>
								<a href="<?php echo UrlHelper::getRoot() ?>permissoes/delete/<?php echo $item->id ?>" id="btn-delete" class="btn btn-danger btn-mini">Apagar</a>
							</div>
						</td>
					</tr>
				<?php endforeach ?>
...
<div class="well">
	Nenhum registro a ser exibido. <a href="<?php echo UrlHelper::getRoot() ?>permissoes/new">Crie o primeiro agora</a>.
</div>
