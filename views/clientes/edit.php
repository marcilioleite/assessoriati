...
<form action="<?php echo UrlHelper::getRoot() ?>clientes/update/bean" method="post" class="form-horizontal">
	<fieldset>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="endereco" name="endereco" type="text" placeholder="" class="input-xlarge" value="<?php echo $bean->endereco ?>">
				<p class="help-block">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="bairro" name="bairro" type="text" placeholder="" class="input-xlarge" value="<?php echo $bean->bairro ?>">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="cidade" name="cidade" type="text" placeholder="" class="input-xlarge" value="<?php echo $bean->cidade ?>">
			</div>
		</div>
		...
		<script>
			$(function() {
				$("#estado").val("<?php echo $bean->estado ?>")
			})
		</script>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="cep" name="cep" type="text" placeholder="" class="input-xlarge" value="<?php echo $bean->cep ?>">
				<p class="help-block">
					Ex.: 56700-000
				</p>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="telefone2" name="telefone2" type="text" placeholder="" class="input-xlarge"  value="<?php echo $bean->telefone2 ?>">
				<p class="help-block">
					Ex.: (11) 8008-0880
				</p>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea id="observacao" name="observacao"><?php echo $bean->observacao ?></textarea>
			</div>
		</div>
